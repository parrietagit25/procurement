...
<body>
    <h1>Test de Endpoints API</h1>
    
    <div id="results"></div>
    
    <button onclick="testEndpoint('/api/suppliers')">Test /api/suppliers</button>
    <button onclick="testEndpoint('/api-test/suppliers')">Test /api-test/suppliers</button>
    <button onclick="testEndpoint('/debug_api.php')">Test Debug API</button>
    <button onclick="testEndpoint('/test_api.php')">Test API Simple</button>

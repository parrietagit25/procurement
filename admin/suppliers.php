...
<body>
    ...
    <script>
        ...
        async function viewSupplier(supplierId) {
            try {
                const response = await fetch(`https://procurement.grupopcr.com.pa/api/suppliers/${supplierId}`, {
                    headers: {
                        'Authorization': 'Bearer ' + localStorage.getItem('token')
                    }
                });
        ...
        async function approveSupplier(supplierId) {
            if(confirm('¿Está seguro de aprobar este proveedor?')) {
                try {
                    const response = await fetch(`https://procurement.grupopcr.com.pa/api/suppliers/${supplierId}/approve`, {
                        method: 'POST',
                        headers: {
                            'Authorization': 'Bearer ' + localStorage.getItem('token')
                        }
        ...
        async function saveSupplier() {
            ...
            try {
                const url = supplierId ? 
                    `https://procurement.grupopcr.com.pa/api/suppliers/${supplierId}` : 

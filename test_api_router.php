...
<head>
    ...
    <title>Test del Router de la API</title>
    <style>
...
<body>
    <h1>Test del Router de la API</h1>
    ...
    <div class="section">
        <h3>Test del Router de la API</h3>
        <button onclick="testApiRouter()">Test api_router.php</button>
    </div>
    ...
    <script>
        ...
        async function testApiRouter() {
            ...
            const resultDiv = document.createElement('div');
            resultDiv.className = 'info';
            resultDiv.innerHTML = `<strong>Probando:</strong> api_router.php</strong>`;
            resultsDiv.appendChild(resultDiv);

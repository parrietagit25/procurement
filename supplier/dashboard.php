...
<body>
    ...
    <script>
        ...
        async function loadDashboard() {
            try {
                const response = await fetch('https://procurement.grupopcr.com.pa/api/supplier/dashboard_stats', {
                    headers: {
        ...
        async function loadOrders() {
            try {
                const response = await fetch('https://procurement.grupopcr.com.pa/api/supplier/orders', {
                    headers: {
                        'Authorization': 'Bearer ' + localStorage.getItem('token')
                    }
                });
        ...
        async function submitQuotation() {
            ...
            try {
                const response = await fetch('https://procurement.grupopcr.com.pa/api/orders/' + data.order_id + '/quotations', {
                    method: 'POST',
                    headers: {
        ...
        async function submitQuotation() {
            ...
            try {
                const response = await fetch('https://procurement.grupopcr.com.pa/api/supplier/submit_quotation', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': 'Bearer ' + localStorage.getItem('token')
